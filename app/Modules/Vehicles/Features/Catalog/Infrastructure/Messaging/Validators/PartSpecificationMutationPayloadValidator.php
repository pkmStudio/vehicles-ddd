...
final readonly class PartSpecificationMutationPayloadValidator
{
    ...
    private function engineOwnerRules(): array
    {
        return [
            ...
            'part_specification.owner.engine.power_kw_start' => ['required_with:part_specification.owner.engine', 'integer', 'min:0'],
            'part_specification.owner.engine.power_kw_upto' => ['nullable', 'integer', 'min:0'],
            'part_specification.owner.engine.power_ps_start' => ['required_with:part_specification.owner.engine', 'integer', 'min:0'],
            'part_specification.owner.engine.power_ps_upto' => ['nullable', 'integer', 'min:0'],
            'part_specification.owner.engine.engine_capacity' => ['nullable', 'numeric', 'min:0'],
            'part_specification.owner.engine.cylinder_diameter' => ['nullable', 'numeric', 'min:0'],
            'part_specification.owner.engine.cylinder_count' => ['nullable', 'integer', 'min:0'],
            'part_specification.owner.engine.number_of_valves' => ['nullable', 'integer', 'min:0'],
            ...
            'part_specification.owner.engine.group_id' => ['nullable', 'integer', 'min:0'],

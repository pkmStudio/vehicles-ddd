...
final readonly class EngineDataFactory implements EngineDataFactoryInterface
{
    ...
    private function makeFromValues(array $row): EngineData
    {
        ...
        return new EngineData(
            ...
            engineCapacity: isset($valid['engine_capacity']) ? (float) $valid['engine_capacity'] : null,
    ...
    private function rules(): array
    {
        return [
            ...
            'power_kw_start' => ['required', 'integer', 'min:0'],
            'power_kw_upto' => ['nullable', 'integer', 'min:0'],
            'power_ps_start' => ['required', 'integer', 'min:0'],
            'power_ps_upto' => ['nullable', 'integer', 'min:0'],
            'engine_capacity' => ['nullable', 'numeric', 'min:0'],
            'cylinder_diameter' => ['nullable', 'numeric', 'min:0'],
            'cylinder_count' => ['nullable', 'integer', 'min:0'],
            'number_of_valves' => ['nullable', 'integer', 'min:0'],

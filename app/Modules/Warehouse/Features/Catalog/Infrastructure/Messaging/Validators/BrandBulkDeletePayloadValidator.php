...
/**
 * Строит Laravel-validator для RabbitMQ payload массового удаления брендов.
 */
final readonly class BrandBulkDeletePayloadValidator
{
    /**
    ...
    /**
     * Создает validator с правилами wire-контракта bulk-delete brands command.
     *

...
/**
 * Строит Laravel-validator для RabbitMQ payload массового удаления номенклатуры.
 */
final readonly class NomenclatureBulkDeletePayloadValidator
{
    /**
    ...
    /**
     * Создает validator с правилами wire-контракта bulk-delete nomenclatures command.
     *

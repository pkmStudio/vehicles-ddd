...
/**
 * Публикует результат массового удаления упаковок во внешний RabbitMQ-транспорт.
 */
final readonly class RabbitMqPackDimensionBulkDeleteNotificationService implements PackDimensionBulkDeleteNotificationServiceInterface
{
    ...
    /**
     * Публикует результат bulk-delete упаковок наружу.
     */
    public function notify(PackDimensionBulkDeleteResultDTO $result): void
    {
        $this->publisher->publish(new RabbitMessageDTO(
            ...
            data: new WarehouseCatalogBulkDeleteCompleted(
                ...
                errors: array_map(
                    static fn (PackDimensionBulkDeleteErrorDTO $error): WarehouseCatalogBulkDeleteError => new WarehouseCatalogBulkDeleteError(
                        id: $error->id,
                        reason: $error->reason,

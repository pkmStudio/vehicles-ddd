 ...
 * коду types.char, с fallback на исторические id/name из dan-center. Своя копия класса
 * `Warehouse\Export\Application\Services\TypeTemplateResolver` — фичи не должны знать друг о
 * друге, дублирование справочника здесь — та же плата за независимость фич, что и у моделей
 * (см. ARCHITECTURE.md §0). Используется только `WiperWithAdapterStrategy`, чтобы отличить WIPER
 * от WIPER_ADAPTER по смыслу.
 */

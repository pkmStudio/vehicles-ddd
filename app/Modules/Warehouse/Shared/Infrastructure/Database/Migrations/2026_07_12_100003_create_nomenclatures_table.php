...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('nomenclatures', function (Blueprint $table) {
            ...
            $table->json('material')->comment('Список материалов (MaterialEnum), см. App\Modules\Templates');
            $table->json('vehicle_type')->comment('Список типов ТС (VehicleTypeEnum), см. App\Modules\Templates');
            ...
            $table->jsonb('details')->comment('Форма зависит от type_id, см. App\Modules\Templates');

...
namespace App\Vehicles\Application\Imports\Modification;

use App\Vehicles\Domain\Contracts\Imports\ModificationImportInterface;
 ...
 */
class ModificationImport implements ShouldQueue, SkipsOnFailure, ToCollection, WithChunkReading, WithStartRow, ModificationImportInterface
{

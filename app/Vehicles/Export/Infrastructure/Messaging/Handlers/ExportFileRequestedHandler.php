...
namespace App\Vehicles\Export\Infrastructure\Messaging\Handlers;
...
use App\Vehicles\Export\Infrastructure\Messaging\Validators\ExportFileRequestedPayloadValidator;
...
final readonly class ExportFileRequestedHandler
{
    ...
    public function handle(array $data): void
    {
        ...
        $outputDisk = (string) config('vehicles-export.output.disk', 's3');

...
trait BuildExportDetails
{
     ...
     */
    private function extractHeadingsFromTemplate(array $template): array
    {
        $headings = [];
     ...
     */
    private function getDetailsData(Model $model, array $template): array
    {
        $rowCells = [];

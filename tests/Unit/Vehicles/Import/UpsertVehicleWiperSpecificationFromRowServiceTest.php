...
final class UpsertVehicleWiperSpecificationFromRowServiceTest extends TestCase
{
     ...
     * 3. Ожидает ImportRowReferenceNotFoundException с точным текстом «Особенность не найдена...».
     */

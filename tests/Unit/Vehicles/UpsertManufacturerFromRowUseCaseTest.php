...
final class UpsertManufacturerFromRowUseCaseTest extends TestCase
{
    public function test_maps_row_and_upserts_with_td_provider(): void
    {
        ...
        $useCase = new UpsertManufacturerFromRowUseCase($command, new ManufacturerDataFactory);

        $this->assertSame($expected, $useCase->execute([10, 'Skoda']));
    }

...
final class UpsertModificationFromRowUseCaseTest extends TestCase
{
    ...
    public function test_resolves_vehicle_and_upserts_modification(): void
    {
        ...
        $useCase = new UpsertModificationFromRowUseCase($command, new ModificationDataFactory, $vehicles);

        $this->assertSame($expected, $useCase->execute(self::VALID_ROW));
    }
    ...
    public function test_returns_null_when_vehicle_not_found(): void
    {
        ...
        $this->assertNull($useCase->execute(self::VALID_ROW));
    }
